...
const ProductTable = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get("http://ecomapi-owct.onrender.com/getproducts");
  ...
  const deleteProduct = async (productId) => {
    try {
      await axios.delete(`http://ecomapi-owct.onrender.com/deleteproduct/${productId}`);
  ...
  const updateProduct = async () => {
    try {
      const response = await axios.patch(
        `http://ecomapi-owct.onrender.com/editproduct/${selectedProduct._id}`,
        {
