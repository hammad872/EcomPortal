...
const FileUploadComponent = () => {
  ...
  const handleUpload = async () => {
    try {
      ...
      if (!file) {
        alert("Dear Nofil, Please Upload Invoice First")
        return;
      }
      ...
      formData.append("client", selectedClientObject.id);
      formData.append("file", file, concatenatedFileName);

      const response = await axios.post(
        "https://my-node-app-nsih.onrender.com/upload",
        formData,
        {
          headers: {
      ...
      MySwal.fire({
        ...
        text: `Invoice for ${selectedClient} has been added successfully`,
      });
    } catch (error) {
